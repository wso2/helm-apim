...
|-----|------|---------|-------------|
| aws | object | `{"efs":{"accessPoints":{"carbonDb1":"","carbonDb2":"","solr1":"","solr2":""},"capacity":"","directoryPerms":"","fileSystemId":""},"enabled":true,"region":"","secretsManager":{"secretIdentifiers":{"internalKeystorePassword":{"secretKey":"","secretName":""}},"secretProviderClass":"","serviceAccountName":""}}` | ------------------------------------------------------------------------------------ |
| aws.efs.accessPoints.carbonDb1 | string | `""` | EFS Access Point ID for mounting carbonDB 1 |
| aws.efs.accessPoints.carbonDb2 | string | `""` | EFS Access Point ID for mounting carbonDB 2 |
| aws.efs.accessPoints.solr1 | string | `""` | EFS Access Point ID for mounting solr 1 |
| aws.efs.accessPoints.solr2 | string | `""` | EFS Access Point ID for mounting solr 1 |
...
| azure.persistence.fileShares.carbondb1 | string | `""` | Azure fileshare share name for carbonDB for instance 1 |
| azure.persistence.fileShares.carbondb2 | string | `""` | Azure fileshare share name for carbonDB for instance 2 |
| azure.persistence.fileShares.solr1 | string | `""` | Azure fileshare share name for solr for instance 1 |
| azure.persistence.fileShares.solr2 | string | `""` | Azure fileshare share name for solr for instance 2 |
...
| wso2.apim.configurations.cache.kmToken.enabled | bool | `true` | Gateway KM token cache enabled |

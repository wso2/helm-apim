...
- Run the following commands to deploy the Helm charts:
  ...
  1. Deploy ACP
      ...
      ```bash
      helm install apim-acp wso2/wso2am-acp --version 4.6.0-4 -f default_acp_values.yaml -n apim
      ```

  2. Deploy KM

      ```bash
      helm install apim-km wso2/wso2am-km --version 4.6.0-4 -f default_km_values.yaml -n apim
      ```

  3. Deploy TM

      ```bash
      helm install apim-tm wso2/wso2am-tm --version 4.6.0-4 -f default_tm_values.yaml -n apim
      ```

  4. Deploy GW

      ```bash
      helm install apim-gw wso2/wso2-gw --version 4.6.0-4 -f default_gw_values.yaml -n apim
      ```

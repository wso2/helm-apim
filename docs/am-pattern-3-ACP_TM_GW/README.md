...
- Run the following commands to deploy the Helm charts for the components.
  ...
  3. Deploy GW
      ...
      ```bash
      helm install apim-gw wso2/wso2am-gw --version 4.6.0-1 -f default_gw_values.yaml -n <namespace>
      ```

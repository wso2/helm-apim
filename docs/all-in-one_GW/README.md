# Pattern 3: Helm Chart for Deployment of a Simple Scalable WSO2 API Manager
...
## Contents
- [Pattern 3: API-M Deployment Overview](#pattern-3-helm-chart-for-deployment-of-a-simple-scalable-deployment-of-wso2-api-manager)
  - [Contents](#contents)
